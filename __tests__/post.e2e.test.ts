...
describe('post entity', () => {
  ...
  describe('Post POST->GET by id', () => {
    ...
    it('should return 404 if post does not exist', async () => {
      ...
      await request(app).get(`${POSTS_PATH}/${nonExistingPostId}`).expect(404);
    });
  });
  ...
  describe('Post POST->PUT', () => {
    it('should update post by id', async () => {
      ...
      const getRes = await request(app).get(`${POSTS_PATH}/${postId}`).expect(200);
  ...
  describe('Post POST->DELETE->GET', () => {
    it('should delete post by id', async () => {
      ...
      await request(app).get(`${POSTS_PATH}/${postId}`).expect(404);
    });
    ...
    it('should return 401 if not authorized', async () => {
      ...
      await request(app).delete(`${POSTS_PATH}/${createRes.body.id}`).expect(401);
    });
